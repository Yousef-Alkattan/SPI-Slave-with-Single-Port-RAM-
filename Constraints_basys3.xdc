...
#set_property -dict { PACKAGE_PIN V2    IOSTANDARD LVCMOS33 } [get_ports red_op_A]
#set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports red_op_B]
#set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports opcode[0]]
#set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports opcode[1]]
#set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports opcode[2]]
...
#set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports dir]
